...
void GameEngineTransform::CutParent()
{
	if (nullptr == Parent)
	{
		return;
	...
	TransData.LocalWorldMatrix = TransData.WorldMatrix;
...
void GameEngineTransform::SetParent(GameEngineTransform* _Parent)
{
	...
	{
		//이미 부모의 자식으로 내가 추가되어있는데 또 하는 경우를 방지
